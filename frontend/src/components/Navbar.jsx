...
const Navbar = (props) => {
    const { isAuthenticated, avatar, navigate, globalRole } = useAppContext();
        ...
        <>
            ...
            <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-1 border-b border-gray-300 bg-white relative transition-all ">
                ...
                <div className="cursor-pointer">
                    <img className="h-15 w-15 scale-200 -p-10 " onClick={()=>{
                        navigate("/")
                    }} src={assets.logo} />
                </div>
                ...
                <div className="hidden sm:flex items-center gap-18 ">
                    ...
                    {!isAuthenticated ? (<button onClick={() => {
                        ...
                        }} className="cursor-pointer rounded-full ml-80 h-12 w-12 -m-0.5" />
                    }
                </div>
